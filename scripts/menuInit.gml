...
buttonamount = textfileLength(file_text_open_read(argument0)); //sets the amount of buttons in the menu to the amount of lines of text in the text file
...
textfileReadlines(file_text_open_read(argument0)); //stores the menu titles in the array button_text